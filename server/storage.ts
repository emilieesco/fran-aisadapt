...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const course3: Course = {
      ...
      category: "textes",
      content:
        "<h2>Le Texte Narratif - Cours Complet</h2><p>Un texte narratif raconte une histoire, un événement, une aventure ou une expérience dans l'ordre où les choses se sont passées. C'est le type de texte le plus courant: contes, romans, anecdotes, etc.</p><h3>1. STRUCTURE FONDAMENTALE DU TEXTE NARRATIF</h3><p>Tout texte narratif suit généralement une structure en trois parties:</p><h4>A) LA SITUATION INITIALE (L'Introduction)</h4><p>C'est le début du récit. Elle présente:</p><ul><li><strong>Les personnages:</strong> Qui sont les personnes dans l'histoire? (le héros, les amis, les ennemis...)</li><li><strong>Le lieu:</strong> Où se passe l'histoire? (la maison, l'école, la forêt, la ville...)</li><li><strong>Le temps:</strong> Quand se passe l'histoire? (hier, autrefois, une belle journée d'été...)</li><li><strong>La situation:</strong> Comment les choses étaient avant l'événement principal?</li></ul><p><strong>Exemple:</strong> \"C'était une belle journée d'été. Mathieu et ses amis jouaient dans le parc de la ville. Ils avaient trouvé un vieux coffre sous un grand arbre.\"</p><h4>B) LE NŒUD (L'action ou Le conflit)</h4><p>C'est le cœur de l'histoire. C'est là que:</p><ul><li><strong>Un événement Important se produit:</strong> Quelque chose d'intéressant, d'inattendu ou de surprenant arrive</li><li><strong>Un problème ou un conflit se manifeste:</strong> Le personnage principal rencontre un obstacle, une difficulté</li><li><strong>L'action commence:</strong> Les personnages doivent réagir, prendre des décisions</li><li><strong>Le suspense augmente:</strong> Le lecteur se demande: \"Que va-t-il se passer?\"</li></ul><p><strong>Exemple:</strong> \"Soudain, le coffre s'ouvre... À l'intérieur, il y a une carte au trésor! Mais la carte est incomplète et elle montre un chemin dangereux. Mathieu doit décider: ignorer la carte ou partir à la recherche du trésor?\"</p><h4>C) LE DÉNOUEMENT (La conclusion)</h4><p>C'est la fin de l'histoire. Elle:</p><ul><li><strong>Résout le conflit:</strong> Le problème est résolu (bien ou mal)</li><li><strong>Montre les conséquences:</strong> Qu'est-ce que l'événement a changé?</li><li><strong>Clôt l'histoire:</strong> Le lecteur comprend comment se termine l'aventure</li><li><strong>Peut inclure une morale ou une leçon:</strong> Parfois, on apprend quelque chose de cette histoire</li></ul><p><strong>Exemple:</strong> \"Mathieu et ses amis ont décidé de suivre la carte. Après une longue aventure, ils ont trouvé le trésor! C'était des pièces anciennes et des bijoux. Ils les ont donnés au musée de la ville. Grâce à leur courage, l'histoire des anciens habitants a été découverte.\"</p><h3>2. LES ÉLÉMENTS CLÉS DU TEXTE NARRATIF</h3><h4>A) Les Personnages</h4><ul><li><strong>Personnage principal (Héros):</strong> Celui autour de qui tourne l'histoire</li><li><strong>Personnages secondaires:</strong> Les amis, la famille, les ennemis du héros</li><li><strong>Caractéristiques:</strong> Leur apparence, leur personnalité, leurs traits de caractère</li></ul><h4>B) Le Cadre (Temps et Lieu)</h4><ul><li><strong>Lieu:</strong> Précis ou vague, peut être réel ou imaginaire</li><li><strong>Temps:</strong> Passé, présent, futur; peut être indiqué directement ou non</li><li><strong>Contexte:</strong> Les circonstances générales (époque historique, situation sociale)</li></ul><h4>C) L'Action</h4><ul><li><strong>Les événements:</strong> Ce qui se passe, dans quel ordre</li><li><strong>Le rythme:</strong> Rapide et palpitant, ou lent et réfléchi</li><li><strong>Le Suspense:</strong> Les moments d'incertitude qui gardent le lecteur intéressé</li></ul><h4>D) La Voix narrative</h4><ul><li><strong>1ère personne:</strong> \"J'ai découvert une grotte cachée...\" (je, nous racontent l'histoire)</li><li><strong>3e personne:</strong> \"Mathieu a découvert une grotte cachée...\" (il, elle, ils racontent l'histoire, plus objectif)</li><li><strong>Narrateur omniscient:</strong> Le narrateur connaît tout, y compris les pensées secrètes des personnages</li><li><strong>Narrateur limité:</strong> Le narrateur ne connaît que ce qu'un personnage sait</li></ul><h3>3. LES TEMPS UTILISÉS DANS LE TEXTE NARRATIF</h3><p>Le texte narratif utilise généralement:</p><ul><li><strong>Passé composé:</strong> Pour les événements principaux (\"Mathieu a trouvé le coffre\")</li><li><strong>Imparfait:</strong> Pour les descriptions de fond (\"Il faisait beau, les oiseaux chantaient\")</li><li><strong>Présent narratif:</strong> Parfois, pour rendre l'histoire plus vivante (\"Mathieu arrive au sommet...\")</li><li><strong>Passé simple:</strong> Dans les textes plus formels ou littéraires (rare en français moderne)</li></ul><h3>4. LES TECHNIQUES DE NARRATION</h3><h4>A) Créer du Suspense</h4><ul><li>Poser des questions sans répondre tout de suite</li><li>Utiliser du mystère et de l'incertitude</li><li>Ralentir le rythme avant un moment important</li></ul><h4>B) Développer les Personnages</h4><ul><li>Montrer leurs pensées et leurs sentiments</li><li>Les faire évoluer au cours de l'histoire</li><li>Montrer comment ils réagissent aux événements</li></ul><h4>C) Créer une Atmosphère</h4><ul><li>Utiliser des descriptions sensorielles (sons, couleurs, odeurs, textures)</li><li>Établir le ton (joyeux, sombre, drôle, effrayant)</li></ul><h3>5. EXEMPLE COMPLET DE TEXTE NARRATIF</h3><p><strong>\"L'Aventure du Tresor\"</strong></p><p><strong>Situation initiale:</strong> \"Maxime était un jeune garçon de douze ans qui vivait en Bretagne, une région côtière de France. C'était un garçon courageux et aventurier. Un matin ensoleillé, il se promenait sur la plage quand il a trouvé une vieille bouteille en verre.\"</p><p><strong>Nœud:</strong> \"En ouvrant la bouteille, Maxime a découvert une lettre jaunie et une vieille carte. La lettre disait: 'Celui qui trouvera ce message devra suivre les indices sur cette carte. Un trésor t'attend.' Excité, Maxime a étudié la carte. Elle montrait un chemin à travers la forêt mystérieuse qui surplombait la plage. Mais ses parents lui avaient toujours dit d'éviter cette forêt dangereuse.\"</p><p><strong>Dénouement:</strong> \"Malgré ses peurs, Maxime a décidé de suivre la carte. Après trois heures de marche difficile et parfois effrayante, il a atteint un petit lac caché. Au bord du lac, sous un rocher marqué d'un X, il a trouvé un coffre ancien. À l'intérieur: des pièces d'or, des émeraudes, et une autre lettre qui disait que c'était le trésor d'un pirate du 17e siècle. Maxime a triomphé! Il a donné le trésor au musée local, devenant ainsi le découvreur le plus célèbre de sa ville.\"</p><h3>6. EXERCICES PRATIQUES</h3><p><strong>Exercice 1:</strong> Identifiez les trois parties (situation initiale, nœud, dénouement) dans une histoire.</p><p><strong>Exercice 2:</strong> Créez vos propres personnages et situation initiale pour une histoire.</p><p><strong>Exercice 3:</strong> Écrivez une courte histoire (100-200 mots) en suivant la structure narrative.</p>",
      order: 3,
    };
