...
-   **Texte descriptif — série complète (cours 85–90) :** 6 cours non-FPT sur le texte descriptif : structure (sujet/aspects/sous-aspects), marqueurs de relation (addition, illustration, opposition, synthèse, spatial), procédés de description (vocabulaire précis, adjectifs, comparaison, métaphore, personnification, énumération, champs lexicaux sensoriels), Vrai ou Faux (8 affirmations), Mise en ordre (7 étapes de rédaction), et lecture analytique d'un texte sur le Plateau-Mont-Royal (8 questions QCM). Catégories : ecriture (85–89) et lecture_descriptif (90).
